...
public static class DummyDataSeeder
{
    ...
    public static async Task SeedAsync(AppDbContext context)
    {
        ...
        {
            new() { SellerId = sellerProfile.Id, CategoryId = cat["Mobile"], Name = "iPhone 15 Pro", Description = "A17 Pro, 48MP camera, titanium.", Price = 349999, Stock = 25, IsActive = true, Image = "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=600", CreatedDate = now, CreatedBy = sellerUser.Id },
            new() { SellerId = sellerProfile.Id, CategoryId = cat["Mobile"], Name = "Samsung Galaxy S24 Ultra", Description = "200MP camera, S Pen included.", Price = 289999, Stock = 30, IsActive = true, Image = "https://images.unsplash.com/photo-1610945265064-0e34e55182fa?w=600", CreatedDate = now, CreatedBy = sellerUser.Id },
            ...
            new() { SellerId = sellerProfile.Id, CategoryId = cat["Audio"], Name = "AirPods Pro 2", Description = "Active noise cancellation, spatial audio.", Price = 64999, Stock = 50, IsActive = true, Image = "https://images.unsplash.com/photo-1600294037681-c80b4cb9b434?w=600", CreatedDate = now, CreatedBy = sellerUser.Id },
            new() { SellerId = sellerProfile.Id, CategoryId = cat["Gaming"], Name = "Gaming Console Z", Description = "4K 120fps, ray tracing.", Price = 85000, Stock = 12, IsActive = true, Image = "https://images.unsplash.com/photo-1606144042614-b2417e99c4e9?w=600", CreatedDate = now, CreatedBy = sellerUser.Id },
            new() { SellerId = sellerProfile.Id, CategoryId = cat["Gaming"], Name = "Pro Gaming Headset", Description = "7.1 surround, RGB lighting.", Price = 12500, Stock = 35, IsActive = true, Image = "https://images.unsplash.com/photo-1599669454699-248973623a04?w=600", CreatedDate = now, CreatedBy = sellerUser.Id },
            ...
            new() { SellerId = sellerProfile.Id, CategoryId = cat["Mobile"], Name = "Wireless Power Bank 20K", Description = "Fast charge, dual USB-C.", Price = 4500, Stock = 80, IsActive = true, Image = "https://images.unsplash.com/photo-1609091839311-9a442f8e7936?w=600", CreatedDate = now, CreatedBy = sellerUser.Id },
